...
import com.example.agung.alimanchat.Adapters.FirebaseRecyclerAdapter;
import com.example.agung.alimanchat.Models.ChatModel;
...
public class MainActivity extends AppCompatActivity {
    public static String TAG = "AlImanchat";
    private Firebase mRef;
    private Query mChatRef;
    private long userId = 2;
    private String mName = "Agung";
...
//                showFirebaseLoginPrompt();
        ...
        mRef = new Firebase("https://al-imanchat.firebaseio.com").child("chat");
        ...
        mRecycleViewAdapter = new FirebaseRecyclerAdapter<ChatModel, ChatHolder>(ChatModel.class, R.layout.activity_message, ChatHolder.class, mChatRef) {
            @Override
